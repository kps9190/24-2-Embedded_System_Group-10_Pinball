...
초음파 센서의 경우,게임 판 왼쪽 중앙부분에 구멍을 내고 초음파센서를 끼우는 방식을 사용했습니다. 또한 공이 지나가는것을 감지하는 LED를 근처에 배치함으로써 점수의 출처를 쉽게 알 수 있도록 하였습니다.
또 공이 지나가는것을 감지하면 별도의 위치에 있는 수동 버저에서 소리가 나도록 구성하였습니다.
